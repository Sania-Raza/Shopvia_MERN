...
const DashboardSideBar = ({ active }) => {
  return (
    <div className="w-full h-[90vh] bg-white shadow-sm overflow-y-auto overflow-x-hidden sticky top-0 left-0 z-10">
      {/* Dashboard */}
      <div className="w-full flex items-center p-4">
        <Link to="/dashboard" className="w-full flex items-center">
          ...
          <h5
            className={`hidden md:block pl-3 text-[18px] font-normal ${
