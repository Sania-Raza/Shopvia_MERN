...
export const productData = [
  {
    ...
    description:
      "Product details are a crucial part of any eCommerce website or online marketplace. These details help potential customers make an informed decision about the product they are interested in buying.",
    image_Url: [
      {
        public_id: "test",
...

  {
    ...
    image_Url: [
      ...
      {
        public_id: "test",
        url: "https://eratable.com/wp-content/uploads/2022/08/H51ba6537405f4948972e293927673546u.jpg",
      },
    ],
    shop: {
      name: "Asus Ltd",
